...
from readme_content_providers import UVaReadmeContentProvider
...
def main():
    ...
    generate_readme(base_path / "solutions", UVaReadmeContentProvider())

    with open(base_path / "README.md", "w") as readme_handle:
        readme_handle.write("### UVa Online Judge solutions\n")
        with open(base_path / "solutions" / "README.md", "r") as sub_readme_handle:
